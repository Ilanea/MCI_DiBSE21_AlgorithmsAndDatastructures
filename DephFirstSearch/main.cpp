...
int main() {
    ...
    std::cout << "Djikstra Path: " << std::endl;
    g.performDijkstraPath("Amster", "Mailand");


    std::cout << "DephFirstSearch: " << std::endl;
    g.depthFirstSearch("Wien");

    std::cout << std::endl;

    std::cout << "Edge Weight: " << g.getEdgeWeight("Wien", "London") << std::endl;

    g.setEdgeWeight("Wien", "London", 10);

    std::cout << "Edge Weight: " << g.getEdgeWeight("Wien", "London") << std::endl;

    std::cout << "Edge Weight: " << g.getEdgeWeight("Wien", "Lyon") << std::endl;

    g.setEdgeWeight("Wien", "Lyon", 10);
